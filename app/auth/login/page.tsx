  ...
  return (
    <Card className="border-border-subtle/50 bg-surface/50 backdrop-blur-xl shadow-2xl">
      ...
      <CardContent className="grid gap-4">
        ...
        {magicLinkSent ? (
          <div className="bg-accent/10 border border-accent/20 text-accent text-sm p-4 rounded-xl text-center">
            <Mail className="w-8 h-8 mx-auto mb-2 opacity-50" />
            <p className="font-medium">Magic link sent!</p>
            <p className="text-xs opacity-70 mt-1">Check your email for a sign-in link.</p>
            <Button 
              variant="link" 
              className="mt-4" 
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button 
                ...
                className="h-12"
              >
                {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : <Mail className="mr-2 h-4 w-4" />}
                Magic Link
              </Button>
              <Button 
                variant="secondary" 

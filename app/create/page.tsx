    ...
    <div className="animate-in fade-in duration-500 slide-in-from-bottom-4 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-surface rounded-card border border-border-subtle/50 p-10 shadow-card transition-all duration-300 hover:shadow-card-hover hover:-translate-y-2 hover:scale-[1.01] group relative overflow-hidden flex flex-col">
          ...
          {/* Quick Drafts / Presets */}
          <div className="mt-8 pt-8 border-t border-border-subtle/30">
            <h3 className="text-sm font-bold text-text-secondary/40 uppercase tracking-widest mb-4 flex items-center gap-2">
               Quick Idea Drafts
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {filteredPresets.map((preset) => (
                ...
                >
                  <p className="text-[10px] font-bold text-accent mb-1 group-hover/preset:translate-x-1 transition-transform">{preset.label}</p>
                  <p className="text-xs text-text-primary line-clamp-2 leading-relaxed opacity-60 group-hover/preset:opacity-100">{preset.topic}</p>
                </button>
              ))}
            </div>
          </div>

...
async function generateHooks(topic, provider = 'gemini') {
...
async function generateHooksWithOpenAI(systemPrompt, userPrompt) {
...
async function generatePostWithOpenAI(systemPrompt, userPrompt) {
    const response = await openai.chat.completions.create({
        model: 'gpt-4o-mini',
        messages: [
            {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0.4gwwp._.js.map